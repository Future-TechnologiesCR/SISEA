...
import produc1 from "../assets/img/produc1.png";
import produc2 from "../assets/img/produc2.png";
import produc3 from "../assets/img/produc3.png";
import produc4 from "../assets/img/produc4.png";
import produc5 from "../assets/img/produc5.png";
import produc6 from "../assets/img/produc6.png";
import produc7 from "../assets/img/produc7.png";
import produc8 from "../assets/img/produc8.png";
import produc9 from "../assets/img/produc9.png";
import produc10 from "../assets/img/produc10.png";
import produc11 from "../assets/img/produc11.png";
import produc12 from "../assets/img/produc12.png";
import produc13 from "../assets/img/produc13.png";
import produc14 from "../assets/img/produc14.png";
import produc15 from "../assets/img/produc15.png";
import produc16 from "../assets/img/produc16.png";
import produc17 from "../assets/img/produc17.png";
import produc18 from "../assets/img/produc18.png";
import produc19 from "../assets/img/produc19.png";
import produc20 from "../assets/img/produc20.png";
import produc21 from "../assets/img/produc21.png";
import kit1 from "../assets/img/kit1.png";
import kit2 from "../assets/img/kit2.png";
import kit3 from "../assets/img/kit3.png";
import kit4 from "../assets/img/kit4.png";
import kit5 from "../assets/img/kit5.png";
import kit6 from "../assets/img/kit6.png";
import kit7 from "../assets/img/kit7.png";
import kit8 from "../assets/img/kit8.png";
      ...
      <div id="Catalogo">
        ...
        <div className="row-catalogo">
          <div className="column-catalogo">
            <Tarjeta img={produc1} title={"Panel de control vista"}>
              ...
              <br />
              Controlado por reloj de tiempo real y con capacidad de 254 eventos
              en memoria.
              <br />
              Agenda hora /Día para usuarios.
            </Tarjeta>
            <Tarjeta img={produc4} title={"Detector de moviviento interno"}>
            ...
            <Tarjeta img={produc7} title={"Contacto magnético"}>
            ...
            <Tarjeta img={produc10} title={"Batería sellada"}>
              Recargable.
              <br />
              Batería de Gel.
              <br />
            ...
            <Tarjeta img={produc19} title={"Cámara de Video WIFI/IP"}>
            ...
            <Tarjeta img={kit1} title={"KIT GAS"}>
            ...
            <Tarjeta img={kit4} title={"KIT 250"}>
              1 Panel de control HONEYWELL
              <br />
              1 Teclado de control
              <br />
            ...
            <Tarjeta img={kit7} title={"KIT 4 Cámaras"}>
          ...
          <div className="column-catalogo">
            <Tarjeta img={produc2} title={"Módulo de comunicación GRR-SISEA"}>
            ...
            <Tarjeta img={produc5} title={"Detector de movimiento interno"}>
            ...
            <Tarjeta img={produc8} title={"Llaves inalámbricas"}>
            ...
            <Tarjeta img={produc11} title={"Sirena"}>
            ...
            <Tarjeta img={produc14} title={"Luz estroboscópica"}>
              Color Roja.
              <br />
              Leyenda en español.
              <br />
            ...
            <Tarjeta img={kit2} title={"KIT 180"}>
              1 Panel de control HONEYWELL
              <br />
              1 Teclado de control
              <br />
            ...
            <Tarjeta className="huge" img={kit2} title={"KIT 200 + 2 CAM"}>
              1 Panel de control HONEYWELL
              <br />
              1 Teclado de control
              <br />
            ...
            <Tarjeta img={kit8} title={"KIT 8 Cámaras"}>
              1 Videograbador digital FULL HD
              <br />
          ...
          <div className="column-catalogo">
            <Tarjeta img={produc3} title={"Teclado de control 6150 RF"}>
              Receptor inalámbrico de 16 Zonas 5881ENM.
              <br />
              Transmisor de estado 5800TM
              <br />
              Solución perfecta cuando se requiera utilizar zonas inalámbricas.
              <br />
            ...
            <Tarjeta img={produc6} title={"Contacto magnético"}>
            ...
            <Tarjeta img={produc9} title={"Transformador 16.5 VAC."}>
            ...
            <Tarjeta img={produc12} title={"Sensor de Humo"}>
            ...
            <Tarjeta img={produc15} title={"Sensor doble tecnología"}>
            ...
            <Tarjeta img={produc18} title={"Cámara de video tipo mini domo"}>
            ...
            >
              ...
              <br />
              Aplicaciones sencillas hasta sistemas muy complejos y sofisticados
              según se requiera.
              <br />
              Controlar y administrar puertas o acciones, según la necesidad.
            </Tarjeta>
            <Tarjeta img={kit3} title={"KIT 200"}>
              1 Panel de control HONEYWELL
              <br />
              1 Teclado de control
              <br />
            ...
            <Tarjeta img={kit6} title={"KIT 200 + 4 CAM"}>
              1 Panel de control HONEYWELL 1 Teclado de control 1 Transformador
              eléctrico 1 Sirena electrónica 1 Batería sellada recargable 4AMP 2
              Detectores de movimiento 2 Contactos simples para puerta 2 Llave
              inalámbrica para ARMAR/DESARMAR 1 Placa distintiva Servicio de
              monitoreo 24/7 Respuesta Armada Motorizada 24/7 (disponible en
              áreas de cobertura) Servicio de reportes vía Email 1 Videograbador
              digital FULL HD 5 Mp de 4 canales salida HDMI 4 Cámaras mini-domo
              FULL HD 5 Mp. 1 Fuente regulada de 4 salidas 1 Disco duro 1Tb SATA
              Tecnología P2P (no requiere IP Fija) Compatible ANDROID/IOS
            </Tarjeta>
          </div>
        </div>
      </div>
